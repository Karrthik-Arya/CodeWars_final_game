...
def ActRobot(robot):
        ...
        if len(robot.GetCurrentBaseSignal())> 0 and  robot.GetInitialSignal()[0]=='b':
                 
                if abs(int(robot.GetInitialSignal()[2])-x)<8 or abs(int(robot.GetInitialSignal()[3])-y)<8 :
                        ob= robot.GetCurrentBaseSignal()[4:]
